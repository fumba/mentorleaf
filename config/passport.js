...
module.exports = function(passport, dev_nconf) {
	...
	// allows us to pass back the entire request to the callback
		...
		if (req.body.email2 !== email) {
			return done(null, false, req.flash('email', req.body.email), req
					.flash('signupMessage', 'Emails do not match.'));
		}
			...
			User.findOne({
				...
				if (user) {
					return done(null, false,
							req.flash('email', req.body.email), req.flash(
									'signupMessage',
